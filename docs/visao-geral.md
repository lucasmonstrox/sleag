...
Afiliados e vendedores do TikTok Shop trabalham hoje no escuro. Eles perdem tempo (e dinheiro) tentando responder perguntas básicas na tentativa e erro:

- **Qual produto vender?**
- **Qual vídeo ou criativo replicar?**
- **Qual comissão realmente vale a pena?**
- **Quais produtos estão começando a crescer — e quais já saturaram?**

A informação existe, mas está espalhada, crua e fora de alcance. Quem descobre tarde demais entra em mercados saturados; quem descobre cedo captura a oportunidade.
...
Permite entender **o que os melhores estão fazendo**: quais produtos promovem, quais criativos usam, com que estratégia e frequência. O usuário aprende com quem já está vendendo, em vez de adivinhar.
...
- **Afiliados** do TikTok Shop que precisam escolher o que promover.
- **Vendedores e lojistas** que precisam decidir o que estocar e anunciar.
- **Criadores de conteúdo e gestores de tráfego** que precisam de referências de criativos que convertem.
...
| Achismo e tendência de feed | Sinais quantificados de demanda e concorrência |

## Modelo de negócio

SaaS por assinatura mensal, em planos escalonados: dos recursos essenciais de descoberta (entrada) até automação completa com API, alertas em tempo real e monitoramento avançado (topo). O detalhamento de planos e funcionalidades por tier fica em documento próprio.

## Objetivo final

**Transformar dados de mercado em oportunidades de venda antes da concorrência.**
